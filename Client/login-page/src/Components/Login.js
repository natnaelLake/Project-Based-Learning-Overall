...
class Login extends Component {
	...
	setInputs(e) {
		...
		this.setState((prevInputs)=>({...prevInputs,[name]:value}));
	}
...
<div class="sign-up-htm">
    <form name = "mainForm" id="form">
      ...
      <div class="group">
        <label id="name-label">
          <p>Last NAME</p>
          <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Name" required
		 	onChange={(e)=>{this.setInputs(e)}} 
		  />
        </label>
      </div>
      ...
      <div class="group">
        <label id="email-label" for="email">
          <p>Password</p>
          <input type="password" name="pwdSign" id="pass" class="form-control" placeholder="Password" minLength={6} maxLength={32}
		   required
		   onChange={(e)=>{this.setInputs(e)}}
		   />
        </label>
      ...
      <div class="group">
        <label id="email-label">
          ...
          <input type="password" name="pwdSign2" id="confirm_pass" class="form-control" placeholder="confirm Password"
		   minLength={6} maxLength={32} required 
		   onChange={(e)=>{this.setInputs(e)}}
		   />
        </label>
      </div>
      <input type="submit" value="Register" id="submit" onClick={this.register}/>
		<div class="hr"></div>
		<div class="foot-lnk">
